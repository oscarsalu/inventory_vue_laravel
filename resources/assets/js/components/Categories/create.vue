                    ...
                    <div class="panel-body">
                        <section class="panel">
                            ...
                            <div class="panel panel-footer">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr v-for="(addTd, index) in addRows">
                                            <td><input type="text" class="form-control" placeholder="category" v-model="addTd.category"></td>
                                            <td>
                                                <!-- button -->
                                ...
                                <button class="btn btn-primary pull-right" @click="addSerial">Add category</button>
                            </div>
                        </section>
