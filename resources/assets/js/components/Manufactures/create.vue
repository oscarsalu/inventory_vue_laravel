                    ...
                    <div class="panel-body">
                        <section class="panel">
                            ...
                            <div class="panel panel-footer">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr v-for="(addTd, index) in addRows">
                                            <td><input type="text" class="form-control" placeholder="Manufacture" v-model="addTd.manufacture"></td>
                                            <td>
                                                <!-- button -->
                                ...
                                <button class="btn btn-primary pull-right" @click="addSerial">Add Manufacture</button>
                            </div>
                        </section>
